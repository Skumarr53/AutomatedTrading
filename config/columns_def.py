...
SHORT_NUM_COLS = ['candlestick_length', 'body_length', 'body_mid_point', 'body_to_length_ratio', 'candlestick_length_prev_1', 'body_length_prev_1', 'body_mid_point_prev_1', 
                  'body_to_length_ratio_prev_1', 'candlestick_length_prev_2', 'body_length_prev_2', 'body_mid_point_prev_2', 'body_to_length_ratio_prev_2', 'high_1h', 'low_1h', 
                  'high_5h', 'low_5h', 'high_1d', 'low_1d', 'volume_pct_change_last_interval', 'volume_pct_change_mean_3', 'volume_pct_change_mean_5', 'bollinger_upperband_param1', 
                  'bollinger_middleband_param1', 'bollinger_lowerband_param1', 'bollinger_upperband_param2', 'bollinger_middleband_param2', 'bollinger_lowerband_param2', 
                  'bollinger_upperband_param3', 'bollinger_middleband_param3', 'bollinger_lowerband_param3', 'rsi_param1', 'rsi_param2', 'rsi_param3', 'macd_param1', 
                  'macd_signal_param1', 'macd_hist_param1', 'macd_param2', 'macd_signal_param2', 'macd_hist_param2', 'macd_param3', 'macd_signal_param3', 'macd_hist_param3', 
                  'stochastic_k_param1','stochastic_d_param1', 'stochastic_k_param2', 'stochastic_d_param2', 'stochastic_k_param3', 'stochastic_d_param3', 'adx_param1', 
                  'adx_param2', 'adx_param3', 'ema_short_param1', 'ema_long_param1', 'ema_short_param2', 'ema_long_param2', 'ema_short_param3', 'ema_long_param3', 'vwap', 
                  'atr_param1', 'atr_param2', 'atr_param3', 'obv', 'sar', 'cci_param1', 'cci_param2', 'cci_param3', 'ichimoku_conversion_line_param1', 'ichimoku_base_line_param1', 
                  'ichimoku_leading_span_a_param1', 'ichimoku_leading_span_b_param1', 'ichimoku_lagging_span_param1', 'ichimoku_price_above_cloud_param1', 
                  'ichimoku_conversion_line_param2', 'ichimoku_base_line_param2', 'ichimoku_leading_span_a_param2', 'ichimoku_leading_span_b_param2', 'ichimoku_lagging_span_param2', 
                  'ichimoku_price_above_cloud_param2', 'ichimoku_conversion_line_param3', 'ichimoku_base_line_param3', 'ichimoku_leading_span_a_param3', 'ichimoku_leading_span_b_param3',
                  'ichimoku_lagging_span_param3', 'ichimoku_price_above_cloud_param3']

LONG_NUM_COLS = ['high_14d', 'low_14d', 'high_52w', 'low_52w', 'weighted_bid_price', 'total_bid_volume', 'weighted_ask_price',
                 'total_ask_volume', 'spread', 'buy_sell_pressure_ratio', 'intraday_price_range', 'price_movement_open_close']
